...
var foot = function(tmp){ return "(verify-proof \"" + tmp + "\" (goal) (assumptions) (rules) (rulesets) (proof) (constants) (required) 0)\n" };
...
server.post('/prove', function(req,res){
  ...
  _.each(['goal','rules','rulesets', 'assumptions', 'constants', 'required', 'proof'], function(key){
    out_str += "(defun "+key+" ()\n";
